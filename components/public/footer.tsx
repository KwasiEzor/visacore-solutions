...
export function Footer({ socialLinks = {} }: FooterProps) {
  ...
  const facebookUrl = socialLinks.social_facebook || "#";
  const linkedinUrl = socialLinks.social_linkedin || "#";
  const instagramUrl = socialLinks.social_instagram || "#";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8">
          ...
          <div className="lg:pr-8">
            ...
            <div className="mt-10 flex items-center gap-4">
              <a href={facebookUrl} aria-label="Facebook" className="flex size-12 items-center justify-center rounded-2xl bg-white/5 border border-white/10 transition-all hover:bg-visacore-gold hover:text-white hover:-translate-y-1">
              ...
              <a href={linkedinUrl} aria-label="LinkedIn" className="flex size-12 items-center justify-center rounded-2xl bg-white/5 border border-white/10 transition-all hover:bg-visacore-gold hover:text-white hover:-translate-y-1">
              ...
              <a href={instagramUrl} aria-label="Instagram" className="flex size-12 items-center justify-center rounded-2xl bg-white/5 border border-white/10 transition-all hover:bg-visacore-gold hover:text-white hover:-translate-y-1">
