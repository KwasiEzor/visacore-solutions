...
- Phase 18 completed: added content-aligned cinematic banner backgrounds to the main public page heroes and dynamic service/destination detail heroes via a shared background system, keeping the homepage visual language consistent across the site.
- Phase 19 completed: replaced the flat homepage trust strip with a premium capabilities section featuring stronger editorial hierarchy, balanced service tiles, and a more deliberate visual rhythm.
